...
export const metadata: Metadata = {
  title: "Azure Hotel - Luxury Accommodations & Premium Service",
  description: "Experience world-class luxury at Azure Hotel. Premium suites, exceptional amenities, fine dining, and personalized service in the heart of the city.",
  keywords: ["luxury hotel", "premium accommodations", "five star hotel", "business travel", "vacation", "spa", "fine dining"],
  openGraph: {
    title: "Azure Hotel - Luxury Accommodations & Premium Service",
    description: "Experience world-class luxury at Azure Hotel. Premium suites, exceptional amenities, fine dining, and personalized service.",
    siteName: "Azure Hotel",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/189295/pexels-photo-189295.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Luxury hotel lobby with elegant modern design"
    }]
  },
  twitter: {
